...
| `/portal/chat` | موجود | صفحة تمهيدية للمراسلة مع المدرسة وليست جزءًا من التدفق التنفيذي في العرض |
...
| `/dashboard/chat` | موجود | صفحة تمهيدية للمحادثات الداخلية، اختيارية فقط عند شرح خارطة التطوير |
...
- صفحات `/dashboard/chat` و`/portal/chat` و`/dashboard/assistant` و`/portal/assistant` موجودة كتأسيس واجهة وبنية فقط، ولا تنفذ مراسلة فورية أو Gemini في النسخة الحالية.
